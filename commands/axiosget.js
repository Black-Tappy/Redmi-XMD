...
zokou({
  ...
  try {
    ...
    const replyText = "*Wait Redmi-XMD is getting your pair code 💧✅...*";
...
*Redmi-XMD TECH Element Information:*
🚀 *Name:* ${data.name}
🚀 *Symbol:* ${data.symbol}
...
Regards ${conf.BOT} `;
    ...
    await zk.sendMessage(dest, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "Redmi-XMD ELEMENT INFORMATION",
...
zokou({
  ...
  if (!githubUsername) {
    return repondre("Give me a valid GitHub username like: github Redmi-XMDweb");
  }
...
`;
    ...
    await zk.sendMessage(dest, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "Redmi-XMD GITHUB USER INFO",
