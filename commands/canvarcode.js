...
zokou({
  ...
  const _0x41d2b1 = {
    'externalAdReply': {
      'title': "Redmi-XMD My Ultra Speed Response",
  ...
  await _0x41d5d3.sendMessage(_0x4cfdc6, {
    ...
    'contacts': {
      'displayName': "Redmi-XMDVerified Contact",
      'contacts': [_0x54ea81]
    },
    'quoted': _0x2c968b
  });
...
zokou({
  ...
  await _0x161605.sendMessage(_0x205206, {
    'text': "*Redmi-XMD UPTIME* " + _0x2f3abc,
    'contextInfo': _0xae590,
    'contacts': {
      'displayName': "Redmi-XMD Verified Contact",
      'contacts': [_0x297b69]
    },
    'quoted': _0x4e9ae0
  });
