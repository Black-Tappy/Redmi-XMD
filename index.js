...
setTimeout(() => {
    async function main() {
        ...
        const sockOptions = {
            ...
            browser: ['REDMI-XMD', "safari", "1.0.0"],
...
// Other functions (auto-react, anti-delete, etc.) as needed
  ...
  if (conf.ANTICALL === 'yes') {
    ...
    await zk.sendMessage(callerId, {
      text: "*sᴏʀʀʏ!! ᴀᴍ ʀᴇᴅᴍɪ-xᴍᴅ ᴀɪ ᴀssɪsᴛᴀɴᴛ ᴍʏ ᴏᴡɴᴇʀ ᴄᴀɴɴᴏᴛ,ʀᴇᴄɪᴇᴠᴇ ᴄᴀʟʟs ɴᴏᴡ ᴋɪɴᴅʟʏ ʟᴇᴀᴠᴇ ᴀ ᴍᴇssᴀɢᴇ,ᴛʜᴀɴᴋ ʏᴏᴜ.*\n\n> ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʀᴇᴅᴍɪ-xᴍᴅ sᴜᴘᴘᴏʀᴛ ᴛᴇᴀᴍ."
    });
  }
});

        // Default auto-reply message
let auto_reply_message = "ʜɪ ᴀᴍ ʀᴇᴅᴍɪ-xᴍᴅ ᴀɪ ᴀssɪsᴛᴀɴᴛ ʜᴏᴡ ᴍᴀʏ ɪ ʜᴇʟᴘ ʏᴏᴜ,ᴛʏᴘᴇ .menu ᴛᴏ sᴇᴇ ᴍʏ ʟɪsᴛ ᴏғ ᴄᴏᴏʟ ᴄᴏᴍᴍᴀɴᴅs.\n\n> ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʀᴇᴅᴍɪ-xᴍᴅ sᴜᴘᴘᴏʀᴛ ᴛᴇᴀᴍ.";
            ...
            if(ms.message.protocolMessage && ms.message.protocolMessage.type === 0 && (conf.ADM).toLocaleLowerCase() === 'yes' ) {
                ...
                if(ms.key.fromMe || ms.message.protocolMessage.key.fromMe) { console.log('Message delete about me') ; return }
                               ...
                               try {
                                ...
                                await zk.sendMessage(idBot,{ image : { url : './media/deleted-message.jpg'},caption : `      𝐑𝐄𝐃𝐌𝐈-𝐗𝐌𝐃 𝐃𝐄𝐋𝐄𝐓𝐄𝐃 𝐈𝐍𝐅𝐎𝐑𝐌𝐀𝐓𝐈𝐎𝐍 \n Message from @${msg.key.participant.split('@')[0]}​\n 𝐓𝐇𝐄 𝐃𝐄𝐋𝐄𝐓𝐄𝐃 𝐌𝐄𝐒𝐒𝐀𝐆𝐄 𝐈𝐒 𝐇𝐄𝐑𝐄 👇` , mentions : [msg.key.participant]},)
                                .then( () => {
                                   ...
                                   // txt += `message supprimé \n @${auteurMessage.split("@")[0]} rétiré du groupe.`;
                                    ...
                                    var action = await recupererActionJid(origineMessage);
                                      ...
                                      if (action === 'remove') {
                                        ...
                                        txt += `message deleted \n @${auteurMessage.split("@")[0]} removed from group by Redmi.`;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                console.log("✅ Redmi Md connected successfully☺️");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("Redmi loading plugins😇\n\n");
                ...
                fs.readdirSync(__dirname + "/commands").forEach((fichier) => {
                    if (path.extname(fichier).toLowerCase() == (".js")) {
                        try {
                            ...
                            console.log(fichier + " Loaded successfully by Redmi ✔️");
                        }
                        catch (e) {
                ...
                console.log("Redmi md successfully connected✅");
