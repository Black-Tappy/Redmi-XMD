...
module.exports = { session: process.env.SESSION_ID || 'keith',
    ...
    GITHUB : process.env.GITHUB|| 'https://github.com/Black-Tappy/Redmi-XMD',
    OWNER_NAME : process.env.OWNER_NAME || "Blacktappy",
   ...
   GREET_MSG: process.env.GREET_MSG || "Huskii am unavailable mzee 😂",               
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || 'viewed by Redmi-XMD',   
